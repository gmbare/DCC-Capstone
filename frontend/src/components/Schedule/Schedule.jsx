...
const Schedule = (props) => {
    ...
    const { date, zip_code } = location.state
    ...
    const handleScheduleSubmit = async (e) => {
        ...
        //   sendUpdates:"all"}
        let res = await axios({
            method: 'put', url: `http://localhost:3001/api/studio/${params.studioId}/${params.artistId}/addcalendarevent`, data: bodyFormData, headers: { "encType": "multipart/form-data" },
        })
        console.log(res.data)
    ...
    try {
        return (<div className='schedule_container' id="schedule_container">
            ...
            {function () {
                ...
                return (<div>
                    <br />Please Login before continuing
                    <br/><br/>
            <Link type="button" to="/login" state={{pastUrl:'/'}} className="login_schedule_btn"> Login or Register</Link>
                </div>)
            }()}
